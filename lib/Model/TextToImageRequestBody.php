...
class TextToImageRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 128)) {
            throw new \InvalidArgumentException('invalid value for $height when calling TextToImageRequestBody., must be bigger than or equal to 128.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 128)) {
            throw new \InvalidArgumentException('invalid value for $width when calling TextToImageRequestBody., must be bigger than or equal to 128.');
        }
    ...
    public function setSeed($seed)
    {
        ...
        if (($seed > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $seed when calling TextToImageRequestBody., must be smaller than or equal to 4294967295.');
        }
        if (($seed < 0)) {
