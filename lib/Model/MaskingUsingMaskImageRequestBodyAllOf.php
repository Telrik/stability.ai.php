...
/**
 * MaskingUsingMaskImageRequestBodyAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MaskingUsingMaskImageRequestBodyAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaskingUsingMaskImageRequestBody_allOf';
    ...
    */
    ...
    public function setTextPrompts($text_prompts)
    {
        ...
        if ((count($text_prompts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text_prompts when calling MaskingUsingMaskImageRequestBodyAllOf., number of items must be greater than or equal to 1.');
        }
