...
/**
 * ImageToImageUsingImageStrengthRequestBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImageToImageUsingImageStrengthRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageToImageUsingImageStrengthRequestBody';
    ...
    */
    ...
    public function setTextPrompts($text_prompts)
    {
        ...
        if ((count($text_prompts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text_prompts when calling ImageToImageUsingImageStrengthRequestBody., number of items must be greater than or equal to 1.');
        }
    ...
    public function setImageStrength($image_strength)
    {
        ...
        if (($image_strength > 1)) {
            throw new \InvalidArgumentException('invalid value for $image_strength when calling ImageToImageUsingImageStrengthRequestBody., must be smaller than or equal to 1.');
        }
        if (($image_strength < 0)) {
            throw new \InvalidArgumentException('invalid value for $image_strength when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 0.');
        }
    ...
    public function setCfgScale($cfg_scale)
    {
        ...
        if (($cfg_scale > 35)) {
            throw new \InvalidArgumentException('invalid value for $cfg_scale when calling ImageToImageUsingImageStrengthRequestBody., must be smaller than or equal to 35.');
        }
        if (($cfg_scale < 0)) {
            throw new \InvalidArgumentException('invalid value for $cfg_scale when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 128)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 128.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 128)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 128.');
        }
    ...
    public function setSamples($samples)
    {
        ...
        if (($samples > 10)) {
            throw new \InvalidArgumentException('invalid value for $samples when calling ImageToImageUsingImageStrengthRequestBody., must be smaller than or equal to 10.');
        }
        if (($samples < 1)) {
            throw new \InvalidArgumentException('invalid value for $samples when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setSeed($seed)
    {
        ...
        if (($seed > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $seed when calling ImageToImageUsingImageStrengthRequestBody., must be smaller than or equal to 4294967295.');
        }
        if (($seed < 0)) {
            throw new \InvalidArgumentException('invalid value for $seed when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 0.');
        }
    ...
    public function setSteps($steps)
    {
        ...
        if (($steps > 150)) {
            throw new \InvalidArgumentException('invalid value for $steps when calling ImageToImageUsingImageStrengthRequestBody., must be smaller than or equal to 150.');
        }
        if (($steps < 10)) {
            throw new \InvalidArgumentException('invalid value for $steps when calling ImageToImageUsingImageStrengthRequestBody., must be bigger than or equal to 10.');
        }
